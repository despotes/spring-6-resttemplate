...
class BeerClientMockTest {
    ...
    void setUp() throws JsonProcessingException {
        ...
        when(manager.authorize(any())).thenReturn(new OAuth2AuthorizedClient(clientRegistration, "test", accessToken));
    ...
    void testListBeersWithQueryParam() throws JsonProcessingException {
        ...
        server.expect(method(HttpMethod.GET))
                ...
                .andExpect(header(HttpHeaders.AUTHORIZATION, BEARER_TEST))
